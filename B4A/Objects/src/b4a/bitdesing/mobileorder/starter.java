...
public class starter extends android.app.Service{
	...
	public void onCreate() {
        ...
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "b4a.bitdesing.mobileorder", "b4a.bitdesing.mobileorder.starter");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.bitdesing.mobileorder.starter", processBA, _service, anywheresoftware.b4a.keywords.Common.Density);
		}
...
public static b4a.bitdesing.mobileorder.fileprovider _provider = null;
public static b4a.bitdesing.mobileorder.ftpserver _server = null;
public static b4a.bitdesing.mobileorder.login_c._sellerdata _seller = null;
...
_provider = new b4a.bitdesing.mobileorder.fileprovider();
 //BA.debugLineNum = 19;BA.debugLine="Public Server As FTPServer";
_server = new b4a.bitdesing.mobileorder.ftpserver();
 //BA.debugLineNum = 22;BA.debugLine="Dim Seller As SellerData";
_seller = new b4a.bitdesing.mobileorder.login_c._sellerdata();
 //BA.debugLineNum = 24;BA.debugLine="Type BusinessData (RAZONSOCIAL As String, DOMICIL";
;
 //BA.debugLineNum = 38;BA.debugLine="End Sub";
return "";
}
public static b4a.bitdesing.mobileorder.starter._businessdata  _selectbusiness() throws Exception{
b4a.bitdesing.mobileorder.starter._businessdata _bd = null;
...
_bd = new b4a.bitdesing.mobileorder.starter._businessdata();
...
public static b4a.bitdesing.mobileorder.customers_c._customersdata  _selectcustomer(int _id) throws Exception{
...
public static b4a.bitdesing.mobileorder.products_c._productsdata  _selectproduct(int _id) throws Exception{
...
anywheresoftware.b4a.keywords.Common.LogImpl("01835019",_bdfile,0);
