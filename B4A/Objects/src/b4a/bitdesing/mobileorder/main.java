...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.bitdesing.mobileorder", "b4a.bitdesing.mobileorder.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.bitdesing.mobileorder", "b4a.bitdesing.mobileorder.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.bitdesing.mobileorder.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._b4xpages._delegate /*b4a.bitdesing.mobileorder.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ ();
...
b4a.bitdesing.mobileorder.b4xpagesmanager _pm = null;
 //BA.debugLineNum = 27;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 28;BA.debugLine="Dim pm As B4XPagesManager";
_pm = new b4a.bitdesing.mobileorder.b4xpagesmanager();
...
if (true) return mostCurrent._b4xpages._delegate /*b4a.bitdesing.mobileorder.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (_keycode);
...
mostCurrent._b4xpages._delegate /*b4a.bitdesing.mobileorder.b4xpagesdelegator*/ ._activity_pause /*String*/ ();
...
mostCurrent._b4xpages._delegate /*b4a.bitdesing.mobileorder.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (_permission,_result);
...
mostCurrent._b4xpages._delegate /*b4a.bitdesing.mobileorder.b4xpagesdelegator*/ ._activity_resume /*String*/ ();
...
mostCurrent._b4xpages._delegate /*b4a.bitdesing.mobileorder.b4xpagesdelegator*/ ._create_menu /*String*/ (_menu);
