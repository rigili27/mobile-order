...
public class cameraexclass extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.cameraexclass");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.cameraexclass.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_Camera_FocusDone(b4a.bitdesing.mobileorder.cameraexclass parent,boolean _success) {
this.parent = parent;
this._success = _success;
}
b4a.bitdesing.mobileorder.cameraexclass parent;
boolean _success;
...
public b4a.bitdesing.mobileorder.cameraexclass._camerainfoandid  _findcamera(boolean _frontcamera) throws Exception{
b4a.bitdesing.mobileorder.cameraexclass._camerainfoandid _ci = null;
...
_ci = new b4a.bitdesing.mobileorder.cameraexclass._camerainfoandid();
...
public b4a.bitdesing.mobileorder.cameraexclass._camerasize  _getpicturesize() throws Exception{
b4a.bitdesing.mobileorder.cameraexclass._camerasize _cs = null;
...
_cs = new b4a.bitdesing.mobileorder.cameraexclass._camerasize();
...
public b4a.bitdesing.mobileorder.cameraexclass._camerasize  _getpreviewsize() throws Exception{
b4a.bitdesing.mobileorder.cameraexclass._camerasize _cs = null;
...
public b4a.bitdesing.mobileorder.cameraexclass._camerasize[]  _getsupportedpicturessizes() throws Exception{
...
_cs = new b4a.bitdesing.mobileorder.cameraexclass._camerasize[_list1.getSize()];
{
int d0 = _cs.length;
for (int i0 = 0;i0 < d0;i0++) {
_cs[i0] = new b4a.bitdesing.mobileorder.cameraexclass._camerasize();
}
}
;
...
public b4a.bitdesing.mobileorder.cameraexclass._camerasize[]  _getsupportedpreviewsizes() throws Exception{
anywheresoftware.b4a.objects.collections.List _list1 = null;
b4a.bitdesing.mobileorder.cameraexclass._camerasize[] _cs = null;
int _i = 0;
