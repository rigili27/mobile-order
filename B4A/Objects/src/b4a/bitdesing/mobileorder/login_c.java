...
public class login_c extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.login_c");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.login_c.class).invoke(this, new Object[] {null});
        else
...
public b4a.bitdesing.mobileorder.b4xcombobox _cuser = null;
public b4a.bitdesing.mobileorder.b4xfloattextfield _txtpassword = null;
...
anywheresoftware.b4a.objects.collections.List _lista = null;
 ...
 //BA.debugLineNum = 38;BA.debugLine="sql.Initialize(Starter.Route, Starter.DataBase, T";
_sql.Initialize(_starter._route /*String*/ ,_starter._database /*String*/ ,__c.True);
 //BA.debugLineNum = 40;BA.debugLine="rs = sql.ExecQuery(\"SELECT * FROM VendMovil\")";
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(_sql.ExecQuery("SELECT * FROM VendMovil")));
 //BA.debugLineNum = 42;BA.debugLine="Dim lista As List";
_lista = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 43;BA.debugLine="lista.Initialize";
_lista.Initialize();
 //BA.debugLineNum = 45;BA.debugLine="If rs.RowCount > 0 Then";
if (_rs.getRowCount()>0) { 
 //BA.debugLineNum = 46;BA.debugLine="Do While rs.NextRow";
while (_rs.NextRow()) {
 //BA.debugLineNum = 47;BA.debugLine="lista.Add(rs.GetString(\"NOMBRE\"))";
_lista.Add((Object)(_rs.GetString("NOMBRE")));
 }
;
 };
 //BA.debugLineNum = 50;BA.debugLine="rs.Close";
_rs.Close();
 //BA.debugLineNum = 52;BA.debugLine="cUser.SetItems(lista)";
...
__c.LogImpl("02097155","create login page",0);
...
_txtpassword._gettextfield /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().setColor(__c.Colors.White);
 //BA.debugLineNum = 32;BA.debugLine="btnLogin.SetColorAndBorder(Colors.RGB(240,248,255";
...
b4a.bitdesing.mobileorder.login_c._sellerdata _sd = null;
 //BA.debugLineNum = 55;BA.debugLine="Private Sub btnLogin_Click";
 //BA.debugLineNum = 57;BA.debugLine="sql.Initialize(Starter.Route, Starter.DataBase, T";
_sql.Initialize(_starter._route /*String*/ ,_starter._database /*String*/ ,__c.True);
 //BA.debugLineNum = 59;BA.debugLine="rs = sql.ExecQuery(\"SELECT * FROM VendMovil WHERE";
_rs = (anywheresoftware.b4a.sql.SQL.ResultSetWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.sql.SQL.ResultSetWrapper(), (android.database.Cursor)(_sql.ExecQuery("SELECT * FROM VendMovil WHERE NOMBRE='"+_cuser._getselecteditem /*String*/ ().trim()+"'")));
 //BA.debugLineNum = 61;BA.debugLine="If rs.RowCount > 0 Then";
if (_rs.getRowCount()>0) { 
 //BA.debugLineNum = 62;BA.debugLine="Do While rs.NextRow";
while (_rs.NextRow()) {
 //BA.debugLineNum = 63;BA.debugLine="If rs.GetString(\"CLAVE\") = txtPassword.Text The";
if ((_rs.GetString("CLAVE")).equals(_txtpassword._gettext /*String*/ ())) { 
 //BA.debugLineNum = 64;BA.debugLine="Dim SD As SellerData";
_sd = new b4a.bitdesing.mobileorder.login_c._sellerdata();
 //BA.debugLineNum = 65;BA.debugLine="SD.Initialize";
_sd.Initialize();
 //BA.debugLineNum = 66;BA.debugLine="SD.CODIGO = rs.GetString(\"CODIGO\")";
_sd.CODIGO /*int*/  = (int)(Double.parseDouble(_rs.GetString("CODIGO")));
 //BA.debugLineNum = 67;BA.debugLine="SD.NOMBRE = rs.GetString(\"NOMBRE\")";
_sd.NOMBRE /*String*/  = _rs.GetString("NOMBRE");
 //BA.debugLineNum = 68;BA.debugLine="SD.CLAVE = rs.GetString(\"CLAVE\")";
_sd.CLAVE /*String*/  = _rs.GetString("CLAVE");
 //BA.debugLineNum = 69;BA.debugLine="Starter.Seller = SD";
_starter._seller /*b4a.bitdesing.mobileorder.login_c._sellerdata*/  = _sd;
 //BA.debugLineNum = 70;BA.debugLine="B4XPages.ClosePage(B4XPages.GetPage(\"login_pag";
_b4xpages._closepage /*String*/ (ba,_b4xpages._getpage /*Object*/ (ba,"login_page"));
 //BA.debugLineNum = 71;BA.debugLine="B4XPages.ShowPageAndRemovePreviousPages(\"home_";
_b4xpages._showpageandremovepreviouspages /*String*/ (ba,"home_page");
 }else {
 //BA.debugLineNum = 76;BA.debugLine="Msgbox2Async(\"Clave incorrecta!!. Intente nuev";
__c.Msgbox2Async(BA.ObjectToCharSequence("Clave incorrecta!!. Intente nuevamente."),BA.ObjectToCharSequence("Atención"),"Aceptar","","",(anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper(), (android.graphics.Bitmap)(__c.Null)),ba,__c.False);
 };
 }
;
 };
...
_cuser = new b4a.bitdesing.mobileorder.b4xcombobox();
...
_txtpassword = new b4a.bitdesing.mobileorder.b4xfloattextfield();
 //BA.debugLineNum = 14;BA.debugLine="Private btnLogin As B4XView";
