...
public class ftpclient extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.ftpclient");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.ftpclient.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public b4a.bitdesing.mobileorder.ftpserver _mserver = null;
public int _mdataport = 0;
public b4a.bitdesing.mobileorder.asyncstreamstext _ast = null;
public b4a.bitdesing.mobileorder.ftpserver._ftpuser _user = null;
public boolean _loggedin = false;
public String _currentpath = "";
public b4a.bitdesing.mobileorder.ftpdataconnection _currentdataconnection = null;
...
__c.LogImpl("011206657","client: "+_text,0);
...
__c.LogImpl("011927553","terminated",0);
...
__c.LogImpl("011403268","CurrentPath: "+_currentpath,0);
...
_currentdataconnection = new b4a.bitdesing.mobileorder.ftpdataconnection();
...
_mserver._clientclosed /*String*/ ((b4a.bitdesing.mobileorder.ftpclient)(this));
...
__c.LogImpl("011730946","Error: "+_msg,0);
...
__c.LogImpl("011272263",BA.ObjectToString(__c.LastException(getActivityBA())),0);
...
b4a.bitdesing.mobileorder.ftpserver._ftpuser _u = null;
...
_u = (b4a.bitdesing.mobileorder.ftpserver._ftpuser)(_mserver._users /*anywheresoftware.b4a.objects.collections.Map*/ .Get((Object)(_user.Name /*String*/ )));
...
__c.LogImpl("011599879","User logged in: "+_user.Name /*String*/ ,0);
...
public String  _initialize(anywheresoftware.b4a.BA _ba,b4a.bitdesing.mobileorder.ftpserver _server,anywheresoftware.b4a.objects.SocketWrapper _socket,int _dataport) throws Exception{
innerInitialize(_ba);
...
_currentdataconnection._initialize /*String*/ (ba,(b4a.bitdesing.mobileorder.ftpclient)(this),_mserver,_mdataport);
...
b4a.bitdesing.mobileorder.ftpclient._ftptask _currenttask = null;
...
_currenttask = new b4a.bitdesing.mobileorder.ftpclient._ftptask();
...
__c.LogImpl("011075586","Timeout!!!",0);
