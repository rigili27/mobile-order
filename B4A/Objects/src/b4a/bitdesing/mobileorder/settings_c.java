...
public class settings_c extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.settings_c");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.settings_c.class).invoke(this, new Object[] {null});
        else
...
_txtip.setText(BA.ObjectToCharSequence(_starter._selectbusiness /*b4a.bitdesing.mobileorder.starter._businessdata*/ ().FTP /*String*/ ));
...
__c.LogImpl("04980739","create settings page",0);
...
__c.LogImpl("05111815","Envia DB",0);
...
public ResumableSub_btnRecibir_LongClick(b4a.bitdesing.mobileorder.settings_c parent) {
this.parent = parent;
}
b4a.bitdesing.mobileorder.settings_c parent;
int _result = 0;
...
parent.__c.LogImpl("047513607","Recibe DB",0);
...
__c.LogImpl("05439489",_serverpath+", Success="+BA.ObjectToString(_success),0);
...
__c.LogImpl("05439491",__c.LastException(ba).getMessage(),0);
...
__c.LogImpl("05373953",_serverpath+", Success="+BA.ObjectToString(_success),0);
 //BA.debugLineNum = 146;BA.debugLine="If Success = False Then";
if (_success==__c.False) { 
 //BA.debugLineNum = 147;BA.debugLine="Log(LastException.Message)";
__c.LogImpl("05373955",__c.LastException(ba).getMessage(),0);
