...
public class orders_c extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.orders_c");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.orders_c.class).invoke(this, new Object[] {null});
        else
...
b4a.bitdesing.mobileorder.b4xpagesmanager._b4amenuitem _addorder = null;
...
__c.LogImpl("03211267","create orders page",0);
...
_addorder = _b4xpages._addmenuitem /*b4a.bitdesing.mobileorder.b4xpagesmanager._b4amenuitem*/ (ba,this,(Object)("Nuevo"));
...
_od = (b4a.bitdesing.mobileorder.orders_c._ordersdata)(_value);
...
public ResumableSub_clvOrders_ItemLongClick(b4a.bitdesing.mobileorder.orders_c parent,int _index,Object _value) {
this.parent = parent;
this._index = _index;
this._value = _value;
}
b4a.bitdesing.mobileorder.orders_c parent;
int _index;
Object _value;
b4a.bitdesing.mobileorder.orders_c._ordersdata _od = null;
int _result = 0;
...
parent.__c.LogImpl("03604488","El usuario eligió Sí.",0);
...
parent.__c.LogImpl("03604496","El usuario eligió No.",0);
 if (true) break;
...
_od = (b4a.bitdesing.mobileorder.orders_c._ordersdata)(_clvorders._getvalue(_i));
