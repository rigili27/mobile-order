...
public class b4xprogressdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.b4xprogressdialog");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.b4xprogressdialog.class).invoke(this, new Object[] {null});
        else
...
public b4a.bitdesing.mobileorder.b4xloadingindicator _loadingindicator = null;
...
_loadingindicator = new b4a.bitdesing.mobileorder.b4xloadingindicator();
...
public String  _show(b4a.bitdesing.mobileorder.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((b4a.bitdesing.mobileorder.b4xdialog) args[0]);
