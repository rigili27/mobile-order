...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public b4a.bitdesing.mobileorder.anotherprogressbar _anotherprogressbar1 = null;
...
_anotherprogressbar1 = new b4a.bitdesing.mobileorder.anotherprogressbar();
...
public ResumableSub_Show(b4a.bitdesing.mobileorder.b4xtimedtemplate parent,b4a.bitdesing.mobileorder.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
b4a.bitdesing.mobileorder.b4xtimedtemplate parent;
