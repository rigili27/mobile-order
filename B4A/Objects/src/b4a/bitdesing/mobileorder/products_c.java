...
public class products_c extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.products_c");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.products_c.class).invoke(this, new Object[] {null});
        else
...
public b4a.bitdesing.mobileorder.b4xfloattextfield _txtsearch = null;
...
public b4a.bitdesing.mobileorder.customers_c._customersdata _customer = null;
...
public ResumableSub_AddItem(b4a.bitdesing.mobileorder.products_c parent,Object _value) {
this.parent = parent;
this._value = _value;
}
b4a.bitdesing.mobileorder.products_c parent;
Object _value;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
b4a.bitdesing.mobileorder.products_c._productsdata _pd = null;
int _result = 0;
...
_pd = (b4a.bitdesing.mobileorder.products_c._productsdata)(_value);
...
_customer = _starter._selectcustomer /*b4a.bitdesing.mobileorder.customers_c._customersdata*/ (_order.CODCLIENTE /*int*/ );
...
__c.LogImpl("02424835","create products page",0);
...
_b4xpages._addmenuitem /*b4a.bitdesing.mobileorder.b4xpagesmanager._b4amenuitem*/ (ba,this,(Object)("Escanear"));
...
_txtsearch = new b4a.bitdesing.mobileorder.b4xfloattextfield();
...
_customer = new b4a.bitdesing.mobileorder.customers_c._customersdata();
...
_pd = (b4a.bitdesing.mobileorder.products_c._productsdata)(_clvproducts._getvalue(_i));
...
_lbldescription.setText(BA.ObjectToCharSequence(_pd.DESCRIPCION /*String*/ ));
 //BA.debugLineNum = 131;BA.debugLine="lblDescription.TextSize = 20";
_lbldescription.setTextSize((float) (20));
...
_lblprecio.setText(BA.ObjectToCharSequence("$ "+BA.NumberToString(_pd.PREVTAPUB1 /*double*/ )));
 ...
 //BA.debugLineNum = 151;BA.debugLine="lblPrecio.TextSize = 22";
_lblprecio.setTextSize((float) (22));
...
_lblcodigo.setText(BA.ObjectToCharSequence("🔢 Código: "+BA.NumberToString(_pd.CODIGO /*int*/ )));
 //BA.debugLineNum = 160;BA.debugLine="lblCodigo.TextSize = 16";
_lblcodigo.setTextSize((float) (16));
...
_lblsku.setText(BA.ObjectToCharSequence("📦 SKU: "+_pd.SKU /*String*/ ));
 //BA.debugLineNum = 168;BA.debugLine="lblSKU.TextSize = 16";
_lblsku.setTextSize((float) (16));
 //BA.debugLineNum = 169;BA.debugLine="lblSKU.TextColor = Colors.Black";
_lblsku.setTextColor(__c.Colors.Black);
 //BA.debugLineNum = 170;BA.debugLine="p.AddView(lblSKU, p.Width/2, 95dip, p.Width/2";
_p.AddView((android.view.View)(_lblsku.getObject()),(int) (_p.getWidth()/(double)2),__c.DipToCurrent((int) (95)),(int) (_p.getWidth()/(double)2-__c.DipToCurrent((int) (10))),__c.DipToCurrent((int) (20)));
...
_pd = new b4a.bitdesing.mobileorder.products_c._productsdata();
