...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.b4xfloattextfield");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.b4xfloattextfield.class).invoke(this, new Object[] {null});
        else
...
public b4a.bitdesing.mobileorder.b4xfloattextfield _mnexttextfield = null;
...
_mnexttextfield = new b4a.bitdesing.mobileorder.b4xfloattextfield();
...
__c.LogImpl("931850520","Multiline not supported with password mode.",0);
 };
...
public b4a.bitdesing.mobileorder.b4xfloattextfield  _getnextfield() throws Exception{
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((b4a.bitdesing.mobileorder.b4xfloattextfield)(this))) { 
...
public String  _setnextfield(b4a.bitdesing.mobileorder.b4xfloattextfield _field) throws Exception{
...
if ((_field).equals((b4a.bitdesing.mobileorder.b4xfloattextfield)(this)) == false) { 
...
_mnexttextfield = (b4a.bitdesing.mobileorder.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(b4a.bitdesing.mobileorder.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
this._toregular = _toregular;
}
b4a.bitdesing.mobileorder.b4xfloattextfield parent;
boolean _toregular;
String _text = "";
int _textcolor = 0;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((b4a.bitdesing.mobileorder.b4xfloattextfield)(this)) == false) { 
