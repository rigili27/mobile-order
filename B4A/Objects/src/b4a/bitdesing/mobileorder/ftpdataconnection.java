...
public class ftpdataconnection extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.ftpdataconnection");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.ftpdataconnection.class).invoke(this, new Object[] {null});
        else
            ba.raiseEvent2(null, true, "class_globals", false);
    }

 public anywheresoftware.b4a.keywords.Common __c = null;
public b4a.bitdesing.mobileorder.ftpclient _mclient = null;
...
public b4a.bitdesing.mobileorder.ftpclient._ftptask _mtask = null;
...
_mclient = new b4a.bitdesing.mobileorder.ftpclient();
...
_mtask = new b4a.bitdesing.mobileorder.ftpclient._ftptask();
...
public String  _initialize(anywheresoftware.b4a.BA _ba,b4a.bitdesing.mobileorder.ftpclient _client,b4a.bitdesing.mobileorder.ftpserver _server,int _port) throws Exception{
innerInitialize(_ba);
...
public String  _settask(b4a.bitdesing.mobileorder.ftpclient._ftptask _task) throws Exception{
