...
public class order_c extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.order_c");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.order_c.class).invoke(this, new Object[] {null});
        else
...
public b4a.bitdesing.mobileorder.b4xfloattextfield _ftxtorderid = null;
public b4a.bitdesing.mobileorder.b4xfloattextfield _ftxtcustomername = null;
...
public b4a.bitdesing.mobileorder.b4xdialog _dialog = null;
public b4a.bitdesing.mobileorder.b4xfloattextfield _txtquantity = null;
public b4a.bitdesing.mobileorder.b4xfloattextfield _txtprecio = null;
public b4a.bitdesing.mobileorder.b4xfloattextfield _txtoff = null;
public b4a.bitdesing.mobileorder.b4xfloattextfield _txtcomentario = null;
public b4a.bitdesing.mobileorder.orders_c._ordersdata _order = null;
...
b4a.bitdesing.mobileorder.products_c _products_page = null;
...
_products_page = (b4a.bitdesing.mobileorder.products_c)(_b4xpages._getpage /*Object*/ (ba,"products_page"));
...
b4a.bitdesing.mobileorder.b4xpagesmanager._b4amenuitem _additem = null;
...
__c.LogImpl("03801091","create order page",0);
...
_b4xpages._addmenuitem /*b4a.bitdesing.mobileorder.b4xpagesmanager._b4amenuitem*/ (ba,this,(Object)("Recibe"));
 //BA.debugLineNum = 55;BA.debugLine="B4XPages.AddMenuItem(Me, \"Comentarios\")";
_b4xpages._addmenuitem /*b4a.bitdesing.mobileorder.b4xpagesmanager._b4amenuitem*/ (ba,this,(Object)("Comentarios"));
 //BA.debugLineNum = 56;BA.debugLine="B4XPages.AddMenuItem(Me, \"Firma\")";
_b4xpages._addmenuitem /*b4a.bitdesing.mobileorder.b4xpagesmanager._b4amenuitem*/ (ba,this,(Object)("Firma"));
 //BA.debugLineNum = 57;BA.debugLine="Dim addItem As B4AMenuItem = B4XPages.AddMenuItem";
_additem = _b4xpages._addmenuitem /*b4a.bitdesing.mobileorder.b4xpagesmanager._b4amenuitem*/ (ba,this,(Object)("Agregar"));
...
public ResumableSub_b4xpage_MenuClick(b4a.bitdesing.mobileorder.order_c parent,String _tag) {
this.parent = parent;
this._tag = _tag;
}
b4a.bitdesing.mobileorder.order_c parent;
String _tag;
b4a.bitdesing.mobileorder.products_c _products_page = null;
b4a.bitdesing.mobileorder.b4xinputtemplate _input = null;
int _result = 0;
b4a.bitdesing.mobileorder.b4xsignaturetemplate _signature = null;
...
_products_page = (b4a.bitdesing.mobileorder.products_c)(parent._b4xpages._getpage /*Object*/ (ba,"products_page"));
...
_products_page._order /*b4a.bitdesing.mobileorder.orders_c._ordersdata*/  = parent._order;
...
_input = new b4a.bitdesing.mobileorder.b4xinputtemplate();
...
_signature = new b4a.bitdesing.mobileorder.b4xsignaturetemplate();
...
parent.__c.LogImpl("04128832","firma ok",0);
...
_ftxtorderid = new b4a.bitdesing.mobileorder.b4xfloattextfield();
 //BA.debugLineNum = 12;BA.debugLine="Private ftxtCustomerName As B4XFloatTextField";
_ftxtcustomername = new b4a.bitdesing.mobileorder.b4xfloattextfield();
...
public ResumableSub_clvItems_ItemClick(b4a.bitdesing.mobileorder.order_c parent,int _index,Object _value) {
this.parent = parent;
this._index = _index;
this._value = _value;
}
...
int _index;
Object _value;
b4a.bitdesing.mobileorder.order_c._itemsdata _id = null;
...
_id = (b4a.bitdesing.mobileorder.order_c._itemsdata)(_value);
...
public ResumableSub_clvItems_ItemLongClick(b4a.bitdesing.mobileorder.order_c parent,int _index,Object _value) {
this.parent = parent;
this._index = _index;
this._value = _value;
}
...
parent.__c.LogImpl("04194312","El usuario eligió Sí.",0);
...
parent.__c.LogImpl("04194316","El usuario eligió No.",0);
 if (true) break;
...
_id = (b4a.bitdesing.mobileorder.order_c._itemsdata)(_clvitems._getvalue(_i));
...
public String  _txtsearch_textchanged(String _old,String _new,b4a.bitdesing.mobileorder.orders_c._ordersdata _od) throws Exception{
byte[] _buffer = null;
...
_od = new b4a.bitdesing.mobileorder.orders_c._ordersdata();
...
_od.Customer /*String*/  = _starter._selectcustomer /*b4a.bitdesing.mobileorder.customers_c._customersdata*/ (_od.CODCLIENTE /*int*/ ).NOMBRE /*String*/ ;
...
_id = new b4a.bitdesing.mobileorder.order_c._itemsdata();
...
_id.ProductName /*String*/  = _starter._selectproduct /*b4a.bitdesing.mobileorder.products_c._productsdata*/ (_id.CODARTICULO /*int*/ ).DESCRIPCION /*String*/ ;
