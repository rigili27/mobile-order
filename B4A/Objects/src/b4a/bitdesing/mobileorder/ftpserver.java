...
public class ftpserver extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.ftpserver");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.ftpserver.class).invoke(this, new Object[] {null});
        else
...
_u = new b4a.bitdesing.mobileorder.ftpserver._ftpuser();
...
public String  _clientclosed(b4a.bitdesing.mobileorder.ftpclient _client) throws Exception{
int _i = 0;
...
b4a.bitdesing.mobileorder.ftpclient _client = null;
int _dp = 0;
...
_client = new b4a.bitdesing.mobileorder.ftpclient();
...
_client._initialize /*String*/ (ba,(b4a.bitdesing.mobileorder.ftpserver)(this),_newsocket,_dp);
...
_client = (b4a.bitdesing.mobileorder.ftpclient)(group4.Get(index4));
