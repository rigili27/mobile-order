...
public class scan_c extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.scan_c");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.scan_c.class).invoke(this, new Object[] {null});
        else
...
public b4a.bitdesing.mobileorder.cameraexclass _camex = null;
...
__c.LogImpl("05767171","create scan page",0);
...
_cs = _camex._getpreviewsize /*b4a.bitdesing.mobileorder.cameraexclass._camerasize*/ ();
...
_camex = new b4a.bitdesing.mobileorder.cameraexclass();
...
__c.LogImpl("05832720","Failed to create detector",0);
 };
...
public ResumableSub_StartCamera(b4a.bitdesing.mobileorder.scan_c parent) {
this.parent = parent;
}
b4a.bitdesing.mobileorder.scan_c parent;
String _permission = "";
...
parent.__c.LogImpl("06029316","No permission!",0);
...
parent.__c.LogImpl("06029327","Error opening camera",0);
