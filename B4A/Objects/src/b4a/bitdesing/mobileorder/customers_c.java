...
public class customers_c extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.mobileorder.customers_c");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.mobileorder.customers_c.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("04521987","create customers page",0);
...
b4a.bitdesing.mobileorder.customers_c._customersdata _cd = null;
b4a.bitdesing.mobileorder.orders_c._ordersdata _od = null;
b4a.bitdesing.mobileorder.order_c _order_page = null;
...
_cd = (b4a.bitdesing.mobileorder.customers_c._customersdata)(_value);
...
_sql.ExecNonQuery2("INSERT INTO PedCMovil(CODCLIENTE, CODVENDEDOR, FECHA, QUIENRECIBIO, COMENTARIOS) VALUES(?, ?, ?, ?, ?)",anywheresoftware.b4a.keywords.Common.ArrayToList(new Object[]{(Object)(_cd.CODIGO /*int*/ ),(Object)(_starter._seller /*b4a.bitdesing.mobileorder.login_c._sellerdata*/ .CODIGO /*int*/ ),(Object)(__c.DateTime.getNow()),(Object)(""),(Object)("")}));
...
_order_page = (b4a.bitdesing.mobileorder.order_c)(_b4xpages._getpage /*Object*/ (ba,"order_page"));
 //BA.debugLineNum = 194;BA.debugLine="order_page.Order = OD";
_order_page._order /*b4a.bitdesing.mobileorder.orders_c._ordersdata*/  = _od;
...
_cd = (b4a.bitdesing.mobileorder.customers_c._customersdata)(_clvcustomers._getvalue(_i));
...
_lblname.setText(BA.ObjectToCharSequence(_cd.NOMBRE /*String*/ ));
 //BA.debugLineNum = 102;BA.debugLine="lblName.TextSize = 20";
...
_lblcuit.setText(BA.ObjectToCharSequence("💳 CUIT: "+_cd.NROCUIT /*String*/ ));
 //BA.debugLineNum = 111;BA.debugLine="lblCuit.TextSize = 18";
_lblcuit.setTextSize((float) (18));
...
_lblcat.setText(BA.ObjectToCharSequence("🏷️ Codigo: "+BA.NumberToString(_cd.CODIGO /*int*/ )));
 //BA.debugLineNum = 120;BA.debugLine="lblCat.TextSize = 18";
_lblcat.setTextSize((float) (18));
...
_lblcat.setTextColor(__c.Colors.DarkGray);
 //BA.debugLineNum = 123;BA.debugLine="p.AddView(lblCat, 320dip, 50dip, 100%x - 160di";
_p.AddView((android.view.View)(_lblcat.getObject()),__c.DipToCurrent((int) (320)),__c.DipToCurrent((int) (50)),(int) (__c.PerXToCurrent((float) (100),ba)-__c.DipToCurrent((int) (160))),__c.DipToCurrent((int) (20)));
...
_lbladdress.setText(BA.ObjectToCharSequence("📍 "+_cd.LOCALIDAD /*String*/ +" - "+_cd.DOMICILIO /*String*/ ));
 //BA.debugLineNum = 129;BA.debugLine="lblAddress.TextSize = 18";
_lbladdress.setTextSize((float) (18));
...
_cd = new b4a.bitdesing.mobileorder.customers_c._customersdata();
