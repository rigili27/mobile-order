...
public class b4xcombobox extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.bitdesing.tomapedidos.b4xcombobox");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.bitdesing.tomapedidos.b4xcombobox.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_RaiseEvent(b4a.bitdesing.tomapedidos.b4xcombobox parent) {
this.parent = parent;
}
b4a.bitdesing.tomapedidos.b4xcombobox parent;
int _index = 0;
int _myindex = 0;
