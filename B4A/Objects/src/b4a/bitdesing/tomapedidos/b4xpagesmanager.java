...
__c.LogImpl("913697027",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("913565973","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("913959172","Only top page can be closed",0);
...
__c.LogImpl("913959175","First page cannot be closed",0);
...
__c.LogImpl("914614531","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("914614532","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("913500443","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("915204366","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("915269902","Too many parameters",0);
 break; }
}
;
