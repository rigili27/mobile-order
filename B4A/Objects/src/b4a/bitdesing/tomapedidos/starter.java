...
public static boolean  _existdatabase() throws Exception{
 //BA.debugLineNum = 128;BA.debugLine="Sub ExistDataBase() As Boolean";
 //BA.debugLineNum = 129;BA.debugLine="If File.Exists(Route, DataBase) = False Then";
...
public static boolean  _existdatabasebackup() throws Exception{
 //BA.debugLineNum = 136;BA.debugLine="Sub ExistDataBaseBackup() As Boolean";
 //BA.debugLineNum = 137;BA.debugLine="If File.Exists(Route, DataBaseBackup) = False The";
...
anywheresoftware.b4j.object.JavaObject _context = null;
 //BA.debugLineNum = 168;BA.debugLine="Public Sub GetFileUri (FileName As String) As Obje";
 //BA.debugLineNum = 170;BA.debugLine="Dim f As JavaObject";
_f = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 171;BA.debugLine="f.InitializeNewInstance(\"java.io.File\", Array(Rou";
_f.InitializeNewInstance("java.io.File",new Object[]{(Object)(_route),(Object)(_filename)});
 //BA.debugLineNum = 172;BA.debugLine="Dim fp As JavaObject";
_fp = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 173;BA.debugLine="Dim context As JavaObject";
_context = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 174;BA.debugLine="context.InitializeContext";
_context.InitializeContext(processBA);
 //BA.debugLineNum = 175;BA.debugLine="fp.InitializeStatic(\"android.support.v4.content.F";
_fp.InitializeStatic("androidx.core.content.FileProvider");
 //BA.debugLineNum = 176;BA.debugLine="Return fp.RunMethod(\"getUriForFile\", Array(contex";
...
anywheresoftware.b4a.objects.SpinnerWrapper _s = null;
 //BA.debugLineNum = 179;BA.debugLine="Sub ResetUserFontScale(p As Panel)";
 //BA.debugLineNum = 180;BA.debugLine="For Each v As View In p";
...
_v = (anywheresoftware.b4a.objects.ConcreteViewWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ConcreteViewWrapper(), (android.view.View)(group1.Get(index1)));
 //BA.debugLineNum = 181;BA.debugLine="If v Is Panel Then";
if (_v.getObjectOrNull() instanceof android.view.ViewGroup) { 
 //BA.debugLineNum = 182;BA.debugLine="ResetUserFontScale(v)";
_resetuserfontscale((anywheresoftware.b4a.objects.PanelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.PanelWrapper(), (android.view.ViewGroup)(_v.getObject())));
 ...
 //BA.debugLineNum = 184;BA.debugLine="Dim lbl As Label = v";
...
_lbl = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_v.getObject()));
 //BA.debugLineNum = 186;BA.debugLine="lbl.TextSize = lbl.TextSize / access.GetUserFon";
_lbl.setTextSize((float) (_lbl.getTextSize()/(double)_access.GetUserFontScale()));
 ...
 //BA.debugLineNum = 188;BA.debugLine="Dim s As Spinner = v";
...
_s = (anywheresoftware.b4a.objects.SpinnerWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.SpinnerWrapper(), (anywheresoftware.b4a.objects.SpinnerWrapper.B4ASpinner)(_v.getObject()));
 //BA.debugLineNum = 190;BA.debugLine="s.TextSize = s.TextSize / access.GetUserFontSca";
...
_bd.RAZONSOCIAL /*String*/  = _rs.GetString("RAZONSOCIAL");
 //BA.debugLineNum = 120;BA.debugLine="BD.NRCUIT = rs.GetString(\"NROCUIT\")";
_bd.NRCUIT /*String*/  = _rs.GetString("NROCUIT");
 //BA.debugLineNum = 121;BA.debugLine="BD.FTP = rs.GetString(\"FTP\")";
...
_rs.Close();
 //BA.debugLineNum = 125;BA.debugLine="Return BD";
if (true) return _bd;
...
anywheresoftware.b4j.object.JavaObject _jo = null;
 //BA.debugLineNum = 144;BA.debugLine="Sub ShareDataBase";
 //BA.debugLineNum = 146;BA.debugLine="Dim i As Intent";
_i = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 147;BA.debugLine="i.Initialize(\"android.intent.action.SEND_MULTIPLE";
_i.Initialize("android.intent.action.SEND_MULTIPLE","");
 //BA.debugLineNum = 148;BA.debugLine="i.SetType(\"text/plain\")";
_i.SetType("text/plain");
 //BA.debugLineNum = 150;BA.debugLine="Dim Uris As List";
_uris = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 151;BA.debugLine="Uris.Initialize";
_uris.Initialize();
 //BA.debugLineNum = 153;BA.debugLine="Dim Files As List=File.ListFiles(Route)";
...
_files = anywheresoftware.b4a.keywords.Common.File.ListFiles(_route);
 //BA.debugLineNum = 154;BA.debugLine="For Each bdfile As String In Files";
{
...
_bdfile = BA.ObjectToString(group7.Get(index7));
 //BA.debugLineNum = 155;BA.debugLine="Log(bdfile)";
anywheresoftware.b4a.keywords.Common.LogImpl("05898251",_bdfile,0);
 //BA.debugLineNum = 156;BA.debugLine="Dim u As Uri = GetFileUri(bdfile)";
...
_u = (anywheresoftware.b4a.objects.ContentResolverWrapper.UriWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ContentResolverWrapper.UriWrapper(), (android.net.Uri)(_getfileuri(_bdfile)));
 //BA.debugLineNum = 157;BA.debugLine="Uris.Add(u)";
_uris.Add((Object)(_u.getObject()));
 }
};
 //BA.debugLineNum = 160;BA.debugLine="Dim jo As JavaObject = i";
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(_i.getObject()));
 //BA.debugLineNum = 161;BA.debugLine="jo.RunMethod(\"putParcelableArrayListExtra\", Array";
_jo.RunMethod("putParcelableArrayListExtra",new Object[]{(Object)("android.intent.extra.STREAM"),(Object)(_uris.getObject())});
 //BA.debugLineNum = 162;BA.debugLine="i.Flags = 1";
_i.setFlags((int) (1));
